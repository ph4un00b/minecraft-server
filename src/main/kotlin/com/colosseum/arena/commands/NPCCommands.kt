...
class NPCCommands(
    ...
    private fun handleToggleNPCs(sender: CommandSender, args: Array<out String>) {
    ...
    private fun handleSetNPCHealth(sender: CommandSender, args: Array<out String>) {
        ...
        if (newHealth == null || newHealth <= 0) {
            ...
            commandLogger.logCommand(sender, ArenaCommand.SET_NPC_HEALTH, args, false, mapOf("reason" to "invalid_health", "input" to args[1]))
            return
        }
    ...
    private fun handleSetNPCDamage(sender: CommandSender, args: Array<out String>) {
        ...
        if (newDamage == null || newDamage <= 0) {
            ...
            commandLogger.logCommand(sender, ArenaCommand.SET_NPC_DAMAGE, args, false, mapOf("reason" to "invalid_damage", "input" to args[1]))
            return
        }
    ...
    private fun handleSetNPCCount(sender: CommandSender, args: Array<out String>) {
        ...
        if (newCount == null || newCount < 0 || newCount > 4) {
            ...
            commandLogger.logCommand(sender, ArenaCommand.SET_NPC_COUNT, args, false, mapOf("reason" to "invalid_count", "input" to args[1]))
            return
        }
    ...
    private fun handleSetNPCAttack(sender: CommandSender, args: Array<out String>) {
        ...
        val attackType = when (args[1].lowercase()) {
            ...
            "fireball" -> NPCAttackType.FIREBALL
                ...
                commandLogger.logCommand(sender, ArenaCommand.SET_NPC_ATTACK, args, false, mapOf("reason" to "invalid_attack_type", "input" to args[1]))
                return
            }
        }
